...
사용 중 typeId: 6·8·9·10·11·13·14·15·16·17·18·19·20·21. 신규 모델은 **22+** 사용. typeId 12는 여전히 미사용 (보존).
...
63개 테스트 파일, `test/` 아래 `lib/` 구조와 동일. 도메인 서비스 유닛 테스트 위주. 전체 테스트 578 PASS(M8a 페이즈 4 #4 시점).
