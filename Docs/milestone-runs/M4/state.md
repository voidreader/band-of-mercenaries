...
- [x] 5. 마을 신뢰도 시스템 + 고정 사건 진행 상태 + 페이즈 4 #3 stub 해제
  ...
  - 산출물: `Docs/spec/M4/[spec]20260503_m4-settlement-trust.md` + `Docs/spec/M4/[spec]20260503_m4-settlement-trust_plan.md` (implement-agent 구현 계획 동반 산출)
  - 완료: 2026-05-04
  - 핵심 결정 (구현 단계):
...
- [x] 4. 마을 방문 UI + 거점 3종 + 약초상/의무실 분리
  ...
  - 산출물: `Docs/spec/M4/[spec]20260504_m4-settlement-visit-ui.md` + `Docs/spec/M4/[spec]20260504_m4-settlement-visit-ui_plan.md` (implement-agent 구현 계획 동반 산출)
  - 완료: 2026-05-04
  - 핵심 결정 (구현 단계):
...
- 2026-05-03: 페이즈 4 #5 명세 작성 완료 (Docs/spec/M4/[spec]20260503_m4-settlement-trust.md, spec-pipeline 1회 PASS)
...
- 2026-05-04: 페이즈 4 #4 명세 작성 완료 (Docs/spec/M4/[spec]20260504_m4-settlement-visit-ui.md, spec-pipeline 1회 PASS — Q-1~Q-12 결정 권장안 모두 채택)
